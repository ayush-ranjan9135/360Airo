      ...
      >
        ...
        <div
          style={{
            ...
            background: isDark ? "#09090B" : "#f1f3f9",
            transition: TS,
          }}
          ...
          >
            <div className="flex items-center space-x-3 overflow-hidden text-left">
              <motion.div
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full text-slate-700 dark:text-slate-200 border shrink-0"
              >
              ...
              {!isCollapsed && (
                <div className="flex flex-col overflow-hidden leading-tight">
                  ...
                  >
                    {user?.email || "ayushranjan9531@gmail.com"}
                  </span>
                </div>
              )}
            </div>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <motion.button
                      ...
                      onClick={toggle}
                      style={{ transition: TS }}
                      className="p-1.5 hover:bg-slate-200/60 dark:hover:bg-white/5 rounded-lg text-slate-500 hover:text-slate-900 dark:text-muted-foreground dark:hover:text-white transition-colors cursor-pointer"
                    >
                      {isDark ? (
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <motion.button
                      ...
                      onClick={logout}
                      style={{ transition: TS }}
                      className="p-1.5 hover:bg-slate-200/60 dark:hover:bg-white/5 rounded-lg text-slate-500 dark:text-muted-foreground hover:text-rose-600 dark:hover:text-rose-400 transition-colors cursor-pointer"
                    >
